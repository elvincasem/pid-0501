function savedelivery(){
			...
			if(drno =="" || supplierid==""){
				...
				$.ajax({
					...
					type: 'post',
					data: {receiveddate: receiveddate,drno:drno,aprid:aprid,poid:poid,supplierid:supplierid,invoiceno:invoiceno,warehouseid:warehouseid},
	...
	var purpose = document.getElementById("purpose").value;
			...
			//}else{
				...
				$.ajax({
					url: '../updatedelivery',
					type: 'post',
					data: {receiveddate: receivedate,drno:drno,aprid:aprid,poid:poid,supplierid:supplierid,deliveryid:deliveryid,status:status,invoiceno:invoiceno,warehouseid:warehouseid,purpose:purpose},
					success: function(response) {
						console.log(response);
						//var lastid = JSON.parse(response);
						location.reload();
