...
class Receiving extends CI_Controller
{
	...
	public function savedelivery(){
		...
		$this->receiving_model->adddelivery($receiveddate,$drno,$aprid,$poid,$supplierid,$invoiceno,$warehouseid);
	...
	public function updatedelivery(){
		...
		$this->receiving_model->updatedelivery($receivedate,$drno,$aprid,$poid,$supplierid,$deliveryid,$status,$invoiceno,$warehouseid,$purpose);
