			...
			<div class="block full">
				...
				<div class="form-group">
					...
					<label class="col-md-2 control-label" for="state-normal">Item Description</label>
                        <div class="col-md-4">
                            <textarea id="description" class="form-control" disabled><?php echo $itemsdetails['description'];?></textarea>
                        </div>
                        ...
                        <div class="col-md-2">
                             <input type="text" id="itemqty" name="state-normal" class="form-control" tabindex="0" value="<?php echo $itemsdetails['brand'];?>" tabindex="2" disabled>
                        ...
                        <div class="col-md-3">
                             <input type="text" id="itemqty" name="state-normal" class="form-control" tabindex="0" value="<?php echo $itemsdetails['supName'];?>" tabindex="2" disabled>
							
                        </div>
						<div class="row"></div>
						<label class="col-md-2 control-label" for="state-normal">Base Unit</label>
                        <div class="col-md-2">
                             <input type="text" id="itemqty" name="state-normal" class="form-control" tabindex="0" value="<?php echo $itemsdetails['unit'];?>" tabindex="2" disabled>
							
                        </div>
						<div class="row"></div>
						<label class="col-md-2 control-label" for="state-normal">Current Balance</label>
                        <div class="col-md-2">
                             <input type="text" id="itemqty" name="state-normal" class="form-control" tabindex="0" value="<?php echo $itemsdetails['inventory_qty'];?>" tabindex="2" disabled>
