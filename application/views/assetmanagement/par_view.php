			 ...
			 <!-- Regular Modal -->
                <div id="adddeliverymodal" class="modal bg" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-md">
						...
						<label class="col-md-3 control-label text-right">Dateasd</label>
                        <div class="col-md-7">
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover">
				...
				echo "<td class='center'> 
					...
					<button class='btn btn-danger notification' title='Delete User' id='notification' onClick='deleteasset(".$par_list['parid'].")' ><i class='fa fa-times'></i></button>
				</td>";
				echo "</tr>";
