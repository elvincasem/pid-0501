...
<table border="1" style="border:solid 2px; width:800px;">
	...
	<tr  class="noBorder">
		<td colspan="2">Section: <u>Administrative Unit</u></td>
...
<div style="font-family:Arial;font-size:12px;">
	<div style="float:left;width:0%;position:relative;left:40px;visibility:hidden;"><img width="100" src="<?=base_url();?>public/img/ched_logo.png"></div>
...
<div style="margin-left:500px;">
	...
	<strong>NYMPHA N. BUENIO</strong><br>
	...
	<br>
			...
			<div class="block full">
				...
				?>
								...
								<label class="col-md-2 control-label" for="state-normal">Purchase Order</label>
								 ...
								 <?php
									if($getrelatedpo['pono']==null){
										echo "<button class='btn btn-primary' title='Save Price' href='#generatepomodal' data-toggle='modal' onclick='generatepo();'><i class='fa fa-refresh'></i> Generate PO</button>";
									}
								 ?>
						...
						<label class="col-md-2 control-label" for="state-normal">Awarded Supplier</label>
                        <div class="col-md-3">
