...
<div class="row">
	...
	<tr >
		...
		<td style="width:500px; padding:15px;" rowspan="2" colspan="3"><strong>COMMISSION ON HIGHER EDUCATION<br>HEDC BLDG., GOVT. CENTER, SEVILLA, SFLU<strong></td>
		<td style="width:100px;">AGENCY ACCT. CODE</td>
		<td style="width:100px;">F4723</td>
	...
	<tr>
		<td colspan="6">
			...
			To: <span style="margin-left:10px;">THE PROCUREMENT SERVICE<br>
			<span style="margin-left:35px;">Dep't of Budget & Mgmt., Regional Office No. 1<br>
			<span style="margin-left:35px;">City of San Fernando, La Union, 2500</span>
	...
	<?php
				...
				$amount = number_format($aprlistitems['qty'] * $aprlistitems['unitprice'],2);
				$totalamount +=$amount;
