...
<table border="1" style="border:solid 2px; width:800px;">
	<tr style="border:10px;">
		<td colspan="6" style="text-align:center; border:1px;">
			...
			<h2 style="line-height:1;">Commission on Higher Education</h2>
	...
	<tr  class="noBorder">
		...
		<td colspan="3">Date: <u><?php echo $pomaindetails['podate'];?></u></td>
...
?>
	...
	<div style="text-align:center;margin-left:400px;">
				...
				<strong>NYMPHA N. BUENIO</strong><div style="margin-bottom:-15px;font-weight:bold;"></div>
				_________________________<br>
	...
	<tr style="text-align:center;font-weight:bold; text-align:left;">
		...
		<br><br>
			...
			NYMPHA N. BUENIO<div style="margin-bottom:-15px;font-weight:bold;"></div>
				_________________________<br>
		...
		<br><br>
			<div style="text-align:center;">
			KRIZANNE INIGO<div style="margin-bottom:-15px;font-weight:bold;"></div>
				_________________________<br>
				
				AA III/ Accountant Designate
			</div>
		</td>
