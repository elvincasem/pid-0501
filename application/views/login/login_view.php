...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>eSource - A DIGITAL ASSET MANAGEMENT SOFTWARE 
FOR MODERN ENTERPRISE
		...
		<link id="theme-link" rel="stylesheet" href="<?=base_url()?>public/css/themes/passion.css">
        <!-- END Stylesheets -->
    ...
    <body>
        ...
        <div id="login-container">
            ...
            <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
                <i class="fa fa-cube"></i> <strong>eSource</strong>
            </h1>
            <!-- END Login Header -->
            ...
            <div class="block animation-fadeInQuickInv">
                ...
                <div class="block-title">
                    <div class="block-options pull-right">
                        <a href="#" class="hidden btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="Forgot your password?"><i class="fa fa-exclamation-circle"></i></a>
                        <a href="#" class="hidden btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="Create new account"><i class="fa fa-plus"></i></a>
                    </div>
                    <h2>Please Login</h2>
                </div>
                <!-- END Login Title -->
