...
<div class="row">
   <div class="col-lg-12">
			 ...
			 <!-- Regular Modal -->
                <div id="adddeliverymodal" class="modal bg" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-md">
                        ...
                        <div class="col-md-7">
                            <input type="text" id="products" name="state-normal" class="form-control" tabindex="0" value="">
                        </div>
            ...
            <!-- END Input States Block -->
							...
							<button type="button" id="savesupplierbutton" class="btn btn-effect-ripple btn-primary" onclick="savesupplier();">Add Delivery</button>
	...
	<div class="block full">
		...
		<h5>Supplier List</h5>
			<button type="button" id="adddelivery" class="pull-right btn btn-effect-ripple btn-primary" href="#adddeliverymodal" data-toggle="modal">Add Supplier</button>
